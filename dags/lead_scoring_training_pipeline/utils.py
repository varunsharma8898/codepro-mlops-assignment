...
def encode_features():
    ...
    **NOTE : You can modify the encode_features function used in heart disease's inference
    ...
    if (_is_table_already_populated(cnx, "features")
            and _is_table_already_populated(cnx, "target")):
        print("model_input table already populated")
        return
...
def get_trained_model():
    ...
    SAMPLE USAGE
        get_trained_model()
    """
    _create_sqlit_connection(MLFLOW_PATH, DB_FILE_MLFLOW)
